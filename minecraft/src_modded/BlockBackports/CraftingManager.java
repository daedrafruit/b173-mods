...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		if(config.getProperty("FenceGate").equals("1")) {
		...
		if(config.getProperty("WoodButton").equals("1")) {
			if(config.getProperty("ModernWoodButtonRecipe").equals("1")) {
				this.addRecipe(new ItemStack(Block.buttonWood, 1), new Object[]{"#", Character.valueOf('#'), Block.planks});
			} else {
				this.addRecipe(new ItemStack(Block.buttonWood, 1), new Object[]{"#", "#", Character.valueOf('#'), Block.wood});
			}
		}

		if(config.getProperty("ModernStoneButtonRecipe").equals("1")) {
			this.addRecipe(new ItemStack(Block.button, 1), new Object[]{"#", Character.valueOf('#'), Block.stone});
		} else {
			this.addRecipe(new ItemStack(Block.button, 1), new Object[]{"#", "#", Character.valueOf('#'), Block.stone});
		}

		if(config.getProperty("IronTrapdoor").equals("1")) {
	...
	void addRecipe(ItemStack var1, Object... var2) {
		...
		if(var2[var4] instanceof String[]) {
			String[] var11 = (String[])((String[])((String[])((String[])((String[])((String[])((String[])var2[var4++]))))));
